...
console.warn(`WARNING: Deprecated route module at /src/app/(app)/client/[hostId]/[refId]/service/[serviceId]/page.tsx is being processed. This path should be served by /app/(publicClient)/client/[hostId]/[refId]/service/[serviceId]/page.tsx`);
export const DEPRECATED_ROUTE_client_service_detail = true;
